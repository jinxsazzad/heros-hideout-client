      ...
      <section className="bg-gray-50 min-h-screen flex items-center justify-center">
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          <div className="md:w-1/2 px-8 md:px-16">
            <h2 className="font-bold text-2xl text-[#002D74]">Register Form</h2>
            {error ? (
              <p className=" bg-slate-300 rounded-md text-red-600 text-center">
                {error}
              </p>
            ) : (
              <></>
            )}
            <form onSubmit={handelRegistration} className="flex flex-col gap-4">
              <input
